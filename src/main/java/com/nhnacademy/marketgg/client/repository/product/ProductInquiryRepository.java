...
public interface ProductInquiryRepository {
     ...
     * @since 1.0.0
     */
    void updateInquiryReply(final ProductInquiryReplyRequest replyRequest, final Long inquiryId)
     ...
     * @since 1.0.0
     */
    PageResult<ProductInquiryResponse> retrieveAllInquiry(final Integer page, final Long productId)
            throws UnAuthenticException, UnAuthorizationException, JsonProcessingException;
     ...
     * @since 1.0.0
     */
    PageResult<ProductInquiryResponse> retrieveAllInquiry(final Integer page)
            throws UnAuthenticException, UnAuthorizationException, JsonProcessingException;
     ...
     * @since 1.0.0
     */
    void deleteInquiry(final Long productId, final Long inquiryId)
            throws UnAuthenticException, UnAuthorizationException, JsonProcessingException;
