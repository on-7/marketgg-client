...
public class SearchProductController {
    ...
    @GetMapping("/categories/{categoryCode}/products/search/price/{type}}")
    public ModelAndView searchForCategorySortPriceAsc(@PathVariable final String categoryCode,
    ...
    @GetMapping("/products/search/price/{type}")
