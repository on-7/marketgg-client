...
public interface SearchProductService {
    ...
    /**
     * 지정한 카테고리에서 상품에 대한 검색 후 지정한 타입으로 가격을 정렬할 수 있는 메소드입니다.
     *
     * @param code    - 지정한 카테고리의 식별번호입니다.
     * @param request - 검색을 진행 할 조건을 담은 객체입니다.
     ...
     * @since 1.0.0
     */
    List<SearchProductResponse> searchForCategorySortPrice(final String code,
                                                           final SearchRequest request,
                                                           final String type)
            throws ParseException, JsonProcessingException;

    /**
     * 전체 목록에서 상품에 대한 검색 후 지정한 타입으로 가격을 정렬할 수 있는 메소드입니다.
     *
     * @param request - 검색을 진행 할 조건을 담은 객체입니다.
     * @param type    - 가격의 정렬 타입입니다. (asc, desc)
     * @return 검색어를 통한 검색 결과 목록을 반환합니다.
     ...
     * @since 1.0.0
     */
    List<SearchProductResponse> searchForKeywordSortPrice(final SearchRequest request,
                                                          final String type)
            throws ParseException, JsonProcessingException;
