...
public interface PostService {
     ...
     *
     * @param categoryCode - 조회할 게시글 목록의 게시판 카테고리 식별번호입니다.
     ...
     * @param categoryCode - 지정한 게시글의 게시판 카테고리 식별번호입니다.
     * @return 지정한 게시글의 상세정보를 반환합니다.
     * @since 1.0.0
     */
    PostResponseForDetail retrievePost(final Long postNo, final String categoryCode);
    ...
    List<PostResponse> searchForOption(final String categoryCode, final SearchRequest searchRequest,
                                              final String optionType, final String option) throws JsonProcessingException;
     ...
     * @since 1.0.0
     */
    void deletePost(final Long postNo, final String categoryCode);
     ...
     *
     * @param postNo      - 상태를 변경할 게시판의 식별번호입니다.
