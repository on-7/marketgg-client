...
public interface PostService {
     ...
     * @since 1.0.0
     */
    List<String> retrieveOtoReason() throws UnAuthenticException, UnAuthorizationException;
     ...
     * @since 1.0.0
     */
    List<String> retrieveOtoStatus() throws UnAuthenticException, UnAuthorizationException;
