...
class SearchControllerTest {
    ...
    void searchForCategory() throws Exception {
        given(searchService.searchForCategory(anyString(), any(SearchRequest.class))).willReturn(
                List.of(new SearchProductResponse(
                        1L, "z", "zz", "zzz", "hello", 1000L, "hello")));
    ...
    void searchForKeyword() throws Exception {
        given(searchService.searchForKeyword(any(SearchRequest.class))).willReturn(
                List.of(new SearchProductResponse(
                        1L, "z", "zz", "zzz", "hello", 1000L, "hello")));
